...
public class BeerServiceTest {
    ...
    @Test
    void whenIncrementIsCalledThenIncrementBeerStock() throws BeerNotFoundException, BeerStockExceededIncrementException {
        //given
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    void whenIncrementIsGreatherThanMaxThenThrowException() {
        ...
        // then
        assertThrows(BeerStockExceededIncrementException.class, () -> beerService.increment(expectedBeerDTO.getId(), quantityToIncrement));
    }
    ...
    @Test
    void whenDecrementIsCalledThenDecrementBeerStock() throws BeerNotFoundException, BeerStockExceededDecrementException {
        // given
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    @Test
    void whenDecrementIsCalledToEmptyStockThenEmptyBeerStock() throws BeerNotFoundException, BeerStockExceededDecrementException {
        // given
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    void whenDecrementIsLowerThanZeroThenThrowException() {
        ...
        // then
        assertThrows(BeerStockExceededDecrementException.class, () -> beerService.decrement(expectedBeerDTO.getId(), quantityToDecrement));
    }
